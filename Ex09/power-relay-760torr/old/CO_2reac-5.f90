...
program co_2reac
    ...
    ! ! --------------------
    ! open(1,file='data_out.dat')
    ! !
    ! open(10,file='data_output.dat')
    ! open(11,file='data_t-sei-cons.dat')
    ! open(12,file='data_t-tempera.dat') 
    ! open(13,file='data_t-neutral.dat')
    ! open(14,file='data_vepercent.dat')
    ! open(15,file='data_voltage-current.dat')
    ! open(16,file='data_eefraction.dat')
    ! open(17,file='data_eefraction_SEI.dat')
    
    ! open(18,file='data_eefraction_SEI_last.dat')
    ! open(19,file='data_co2-vib-states.dat')
    ! open(20,file='data_integ-frac.dat')
    ! !
    ! open(31,file='data_1e-12.eedf.dat')    
    ! open(32,file='data_1e-11.eedf.dat')
    ! open(33,file='data_1e-10.eedf.dat')
    ! open(34,file='data_1e-9.eedf.dat')
    ! open(35,file='data_1e-8.eedf.dat')
    ! open(36,file='data_1e-7.eedf.dat')
    ! open(37,file='data_1e-6.eedf.dat')
    ! open(38,file='data_1e-5.eedf.dat')
    ! open(39,file='data_1e-4.eedf.dat')
    ! !
    ! open(99,file='data_log.dat')
    ! ! ----------------------
