...
program test_co2
    ...
    double precision            :: 	time  = 0.0d0, time_end = 4.6d-2, dtime = 1.0d-15, & ! times, s
                                    powertime = 2.3d-2, cooltime = 4.6d-2, ptime = 0.0d0, &
    ...
    do while(time .lt. time_end)
        ...
        if ((ptime > 1.0d-10) .and. (ptime < 1.0d-8) ) then 
            ...
            dtime = 1.0d-8
        else if ( (ptime > 1.0d-4).and. (ptime < powertime) )  then 
            dtime = 1.0d-6
            ...
            dtime = 1.0d-8
        else if ( (ptime > (powertime + 1.0d-4) ) .and. (ptime < cooltime) ) then
            dtime = 1.0d-6
        else
            ! ptime = 0d0
            dtime = 1.0d-15
