...
program test_co2
    ...
    double precision            :: 	time  = 0.0d0, time_end = 2.0d-2, dtime = 1.0d-15, & ! times, s
    ...
    write( 10, '(6a30)' ) "Time", "Reduced field", "Te(K)", "Te(eV)", "Electron density", "Power density"
    ...
    do while(time .lt. time_end)
        ...
        if ((ptime > 1.0d-10) .and. (ptime <= 1.0d-8) ) then 
            ...
            dtime = 1.0d-8
        else if ( (ptime > 1.0d-4).and. (ptime <= 1.0d-2) )  then 
            dtime = 1.0d-6
        else if ( (ptime > 1.0d-2) .and. (ptime <= (1.0d-2 + 1.0d-10)))  then 
            ! ptime = 0d0
            dtime = 1.0d-15
        else if ( (ptime > (1.0d-2 + 1.0d-10) ) .and. (ptime <= (1.0d-2 + 1.0d-8)) ) then
            dtime = 1.0d-12
        else if ( (ptime > (1.0d-2 + 1.0d-8) ) .and. (ptime <= (1.0d-2 + 1.0d-6)) ) then
            dtime = 1.0d-10
        else if ( (ptime > (1.0d-2 + 1.0d-6) ) .and. (ptime <= (1.0d-2 + 1.0d-4)) ) then
            dtime = 1.0d-8
        else if ( (ptime > (1.0d-2 + 1.0d-4) ) .and. (ptime <= (1.0d-2 + 1.0d-2)) ) then
            dtime = 1.0d-6
        else
            ! ptime = 0d0
            dtime = 1.0d-15
