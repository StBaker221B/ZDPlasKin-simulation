...
program test_co2
    ...
    double precision            :: 	time  = 0.0d0, time_end = 1.0d-6, dtime = 1.0d-15, & ! times, s
                                    powertime = 30.0d-9, cooltime = 1.0d-6, ptime = 0.0d0, &
    ...
    do while(time .lt. time_end)
        ...
        if ((ptime > 1.0d-10) .and. (ptime < powertime) ) then 
            dtime = 1.0d-12
        ! ! else if ((ptime > 1.0d-8) .and. (ptime < 1.0d-6) ) then 
        ! !     dtime = 1.0d-10
        ! ! else if ((ptime > 1.0d-6) .and. (ptime < 1.0d-4) ) then 
        ! !     dtime = 1.0d-8
        ! else if ( (ptime > 1.0d-8).and. (ptime < 1.0d-6) .and. (ptime < powertime) )  then 
        !     dtime = 1.0d-10
